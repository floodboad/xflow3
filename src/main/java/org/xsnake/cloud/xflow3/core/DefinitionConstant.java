...
public class DefinitionConstant {
	...
	public static final String ELEMENT_ACTIVITY_CALLBACK = "callback";
	
	public static final String ELEMENT_ACTIVITY_CALLBACK_TYPE = "type";
...
//	public static final String ELEMENT_ACTIVITY_PARTICIPANTS = "participants";
	...
	public static final String TASK_TYPE_DEFINITION = "definition";
	
	public static final String TASK_TYPE_VIRTUAL = "virtual";
	
	public static final String TASK_TYPE_REJECT = "reject";
